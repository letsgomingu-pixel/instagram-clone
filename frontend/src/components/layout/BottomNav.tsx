...
export function BottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 mobile-bottom-nav-safe bg-ig-surface border-t border-ig-border flex items-stretch justify-around z-40">
