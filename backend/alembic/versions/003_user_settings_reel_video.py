...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("notify_likes", sa.Boolean(), nullable=False, server_default=sa.text("1")),
        sa.Column("notify_comments", sa.Boolean(), nullable=False, server_default=sa.text("1")),
        sa.Column("notify_follows", sa.Boolean(), nullable=False, server_default=sa.text("1")),
        sa.Column("notify_mentions", sa.Boolean(), nullable=False, server_default=sa.text("1")),
        sa.Column("is_private", sa.Boolean(), nullable=False, server_default=sa.text("0")),
        sa.Column("show_activity_status", sa.Boolean(), nullable=False, server_default=sa.text("1")),
        sa.Column("allow_story_replies", sa.Boolean(), nullable=False, server_default=sa.text("1")),
